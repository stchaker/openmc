...
extern "C" bool create_transient_source; //!< create a transient_source.h5 for future run? 
...
extern "C" int64_t num_neutrons_time_slice; //!< Number of source sites to generated for a transient run
